jQuery(document).ready(function ($) {
  ...
  let id_notas = "wpforms-3087-field_13";
  ...
  function enviarDatos() {
    ...
    formData.append(
      "tipojugador1",
      document.getElementById(id_tipojugador1).value,
    );
    formData.append(
      "tipojugador2",
      document.getElementById(id_tipojugador2).value,
    );

    let incidencias_concat = [];
    if (document.getElementById(id_check_viernes_tarde).checked)
      incidencias_concat.push(
        document.getElementById(id_check_viernes_tarde).value,
      );
    if (document.getElementById(id_check_viernes_noche).checked)
      incidencias_concat.push(
        document.getElementById(id_check_viernes_noche).value,
      );
    if (document.getElementById(id_check_sabado_manana).checked)
      incidencias_concat.push(
        document.getElementById(id_check_sabado_manana).value,
      );
    if (document.getElementById(id_check_sabado_tarde).checked)
      incidencias_concat.push(
        document.getElementById(id_check_sabado_tarde).value,
      );
    if (document.getElementById(id_check_sabado_noche).checked)
      incidencias_concat.push(
        document.getElementById(id_check_sabado_noche).value,
      );
    ...
    form.addEventListener("submit", function (e) {
      ...
      enviarDatos().then(() => {
        ...
        window.location.href =
          "https://clubpadelandujar.com/inscritos-torneo-marzo-2026/";
      });
    });
  }
});
